...
class NewsModel(models.Model):
    ...
    thumbnail = models.ImageField(verbose_name="عکس کاور", upload_to="img/news/", blank=True, null=True)
    body_pre = models.CharField(verbose_name="متن پیش نمایش", max_length=250)
    body = RichTextUploadingField(verbose_name="محتوا")
    author = models.ForeignKey(UserModel, models.CASCADE, related_name="author_news", verbose_name="نویسنده")
    ...
    def get_absolute_url(self):
        return reverse("news:news_page_page", args=[self.slug])
